...
{
    // A REAL bech32 address (valid checksum) — see the note in
    // CollectionBlankMetadataIntegrationTest. Generated by
    // Bech32::encode('cosmos', sha256('bcc-pr5a-fixture:shared-contract')).
    private const CONTRACT = 'cosmos13tjxslw3k9wsljflhjpcyswd7qy9rjr8qlsargc7rkjd2aq5kvss8xd6h2';
    ...
    protected function setUp(): void
    {
        ...
        // The fixture contract is a Cosmos bech32 address, so the chain must
        // be the Cosmos one. This used to take `ORDER BY id ASC LIMIT 1`,
        // which is Ethereum — an EVM chain holding a bech32 address. Nothing
        // validated the pairing, so the mismatch was invisible; PR 5a makes
        // identity chain-aware and it is now a refusal.
