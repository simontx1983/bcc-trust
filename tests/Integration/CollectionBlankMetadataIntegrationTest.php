...
{
    // A REAL bech32 address (valid checksum), not a bech32-shaped string.
    // PR 5a routes every collection write through NftCollectionIdentifier,
    // which verifies the checksum via Bech32::decode() — the previous
    // `cosmos1blankmetadataaaa…` filler could never have existed on chain
    // and is now correctly refused. Generated by Bech32::encode('cosmos',
    // sha256('bcc-pr5a-fixture:blank-metadata')), so it is reproducible.
    ...
    protected function setUp(): void
    {
        ...
        // be the Cosmos one — see the note in
        // CollectionUpsertCanonicalKeyIntegrationTest::setUp().
